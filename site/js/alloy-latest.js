...
(function (factory) {
	...
	*/
	...
	var hookNames = ["onComponentsRegistered", "onBeforeEvent", "onResponse", "onBeforeDataCollection"];
	...
	*/
	var createPayload = (function () {
	  ...
	  return {
	    ...
	    get expectsResponse() {
	      return Array.isArray(content.events) && content.events.some(function (event) {
	...
	*/
	...
	var createDataCollector = function createDataCollector() {
	  ...
	  var createEventHandler = function createEventHandler(options) {
	    ...
	    return lifecycle.onBeforeEvent(event, options, isViewStart).then(function () {
	...
	*/
	...
	var componentCreators = [createDataCollector, createIdentity, createAudiences, // createPersonalization,
	createContext, createStitch, createLibraryInfo]; // eslint-disable-next-line no-underscore-dangle
